...
if CLIENT then
	...
	local function DrawWeight()
		...
		cam.IgnoreZ(true)
		if (GetConVarNumber("weight_use_oldtooltip") == 0) then
			surface.SetFont("NewTooltip")
			local w,h = surface.GetTextSize(str)
			cam.Start3D2D(trace.Entity:GetPos()+rOBB, ang, trace.StartPos:Distance(trace.Entity:GetPos()+rOBB)/1600)
	...
	CreateClientConVar( "weight_use_oldtooltip", "0", true, false )
end