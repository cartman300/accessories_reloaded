...
if (CLIENT) then
	...
	language.Add("Tool.cloaking.desc", "Allows you to turn things invisible at the touch of a button");
	language.Add("Tool.cloaking.0", "Click on something to make it a cloakable. Reload to remove cloaking from something.");
	...
	function TOOL:BuildCPanel()
		self:AddControl("Header",   {Text = "#Tool.cloaking.name", Description = "#Tool.cloaking.desc"});
